...
contract SFC is Initializable, Ownable, Version {
    ...
    /// Set redirection authorizer for approving redirections
    ...
    // Announce redirection of address to another address
    function announceRedirection(address to) external {
        emit AnnouncedRedirection(msg.sender, to);
    }

    // Initiate redirection request of address to another address
    ...
    // Finish redirection request and redirect address to another address
    ...
    // Seal epoch and distribute rewards
    ...
    // Seal epoch and set validators for the next epoch
    ...
    // Create a validator with a given public key
    ...
    // Get rewards stash for a delegator
    ...
    // Re-stake rewards for stake delegated to a validator
    ...
    // Check delegation limit for a validator
    ...
    // Get highest payable epoch for a validator
    ...
    // Get receiver address and check for redirection
